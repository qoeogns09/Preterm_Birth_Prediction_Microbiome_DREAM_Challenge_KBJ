...
def main():
    ...
    parser.add_argument(
        ...
        default='early_preterm',
        help='Which Task? preterm or early_preterm'
    )
    args = parser.parse_args()

    eclf1 = load('/model_code/models_1.save')
    eclf2 = load('/model_code/models_2.save')
    eclf3 = load('/model_code/models_3.save')
    eclf4 = load('/model_code/models_4.save')
    eclf5 = load('/model_code/models_5.save')
    ...
    selected_features = np.load('use_features.npy', allow_pickle=True)
